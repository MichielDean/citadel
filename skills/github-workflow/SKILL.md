...
| File | Description |
| --- | --- |
| Stacked PR workflow | Merge stacked PRs into main as individual squash commits |

## Problem -> Skill Mapping

| Problem | Start With |
| --- | --- |
| Merge stacked PRs cleanly | See stacked PR workflow summary above |
| Create and manage PRs | Use `gh pr create`, `gh pr merge`, `gh pr checks` |
